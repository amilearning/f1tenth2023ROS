...
from h2h_configs_build import ego_dynamics_config
...
class MPCC_H2H_approx(AbstractController):
    ...
    def _build_solver(self):
        ...
        self.install_dir = self.install(path=self.control_params.solver_dir)  # install the model to ~/.mpclab_controllers
        # Copy solver config.
