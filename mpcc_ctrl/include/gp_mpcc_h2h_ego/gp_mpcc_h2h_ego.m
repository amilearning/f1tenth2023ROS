% gp_mpcc_h2h_ego - a fast solver generated by FORCESPRO v6.2.0
%
%   OUTPUT = gp_mpcc_h2h_ego(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = gp_mpcc_h2h_ego(PARAMS) returns additionally
...
%
%   [OUTPUT, EXITFLAG, INFO] = gp_mpcc_h2h_ego(PARAMS) returns 
