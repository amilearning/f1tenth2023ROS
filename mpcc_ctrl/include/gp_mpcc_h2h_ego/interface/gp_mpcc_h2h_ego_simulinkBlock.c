...
#define S_FUNCTION_NAME gp_mpcc_h2h_ego_simulinkBlock
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 190, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 610, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	/* Call solver */
	solver_exitflag = gp_mpcc_h2h_ego_solve(&params, &output, &info, mem, fp , pt2function_gp_mpcc_h2h_ego);
