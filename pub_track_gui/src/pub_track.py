...
class PublishTrack():
    ...
    def InterativeMarkerCallback(self,msg):
        ...
        for int_marker in msg.markers:
            ...
            marker.pose.orientation.w = self.track[marker.id,6] # ey  ###TODO: previously in 7
