...
#define S_FUNCTION_NAME gp_mpcc_h2h_ego_simulinkBlockcompact
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 190, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	for(i = 0; i < 19; i++)
	{
		outputs[19 + i] = (real_T) output.x02[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[38 + i] = (real_T) output.x03[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[57 + i] = (real_T) output.x04[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[76 + i] = (real_T) output.x05[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[95 + i] = (real_T) output.x06[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[114 + i] = (real_T) output.x07[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[133 + i] = (real_T) output.x08[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[152 + i] = (real_T) output.x09[i];
	}

	for(i = 0; i < 19; i++)
	{
		outputs[171 + i] = (real_T) output.x10[i];
	}
