...
class PathGenerator:
    ...
    def gen_path(self):
        ...
        hstraight2_record = np.array([[2.8, 999.0]])
        stright = np.array([[3.0, 800.0]])
        stright_record = np.array([[2.8, 800.0]])
